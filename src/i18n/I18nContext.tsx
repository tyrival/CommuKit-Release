...
export function I18nProvider({ children }: { children: ReactNode }) {
  const [lang, setLang] = useState<Lang>(() => {
    const saved = localStorage.getItem('commukit-lang')
  ...
  useEffect(() => {
    ...
    document.title = `CommuKit — ${translations[lang].hero.title1}`
  }, [lang])

  return (
    <I18nContext.Provider value={{ lang, t: translations[lang], setLang: (l) => { setLang(l); localStorage.setItem('commukit-lang', l) } }}>
      {children}
