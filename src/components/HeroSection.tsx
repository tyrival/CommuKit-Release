  ...
  return (
    <section className="pt-32 pb-12 relative">
      <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-[1.08] mb-5 max-w-4xl mx-auto">
          <span className="bg-gradient-to-r from-[#0085ff] via-[#00a8ff] to-[#00bfff] bg-clip-text text-transparent">{t.hero.title1}</span>
        </h1>

        <p className="text-lg md:text-xl text-[#6e6e73] dark:text-[#8e8e9a] max-w-2xl mx-auto mt-5 leading-relaxed">
          {t.hero.subtitle}
        </p>

        <div className="flex items-center justify-center gap-4 mt-9 flex-wrap">
          <a href="https://github.com/tyrival/CommuKit-Release/releases/latest/download/CommuKit.dmg"
